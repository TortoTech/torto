...
use crate::BlockRewrite;

/// Opaque undo state returned after changing a derived rewrite layer.
...
///
/// This source is frontend-neutral: egui and GPUI may install the same layer,
/// while durable navigation continues to use the original source node identity.
