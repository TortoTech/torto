...
#[cfg(test)]
use crate::text_block_text;
use crate::{BlockTranslation, TranslationBlockInput, TranslationMode};
...
mod tests {
    use rebook_publication::{
        BlockStyle, CaptionPosition, FigureBlock, FixedPageTextLayer, FixedPageTextRect,
        FixedPageTextSpan, ImageBlock, ImageStyle, Metadata, PublicationId, QuoteBlock,
